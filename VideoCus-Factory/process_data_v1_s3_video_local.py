...
for part_i in part_indexes:
    ...
    save_root = 'sample_label/customization/'
            ...
            for i in common_index:
                ...
                if save_flag:
                    if not has_saved_mask:
                        name_caption_frame_mask = name.replace('.mp4', '_mask.jpg')
                    ...
                    seg_entity_path = save_dir + name.replace('.mp4', f'_entity_{i}.jpg')
                    cv2.imwrite(seg_entity_path, seg_entity)
