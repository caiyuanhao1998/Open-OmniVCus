...
# s3_dir = 'yuanhao_cai/VideoEdit/label/instruct_single_cus_test/'
s3_dir = 'yuanhao_cai/VideoEdit/label/instruct_single_cus_test_all/' #112
...
local_json_path = save_dir + 'instruct_single_cus_test.json'
