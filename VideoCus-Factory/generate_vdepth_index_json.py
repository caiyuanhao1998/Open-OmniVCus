...
s3_dir = 'yuanhao_cai/VideoEdit/label/video2vdepth/'
...
local_json_path = save_dir + 'video2vdepth.json'
with open(local_json_path, 'w') as file:
    json.dump(total_video_names[test_num:], file, indent=4)

# 将所有的 video_names 存到一个 json 文件里
local_json_path_test = save_dir + 'video2vdepth_test.json'
