...
# s3_dir = 'yuanhao_cai/VideoEdit/label/three_cus_test/'
# s3_dir = 'yuanhao_cai/VideoEdit/label/three_cus_test_2/'
s3_dir = 'yuanhao_cai/VideoEdit/label/three_cus_test_3/'
...
local_json_path = save_dir + 'three_cus_test.json'
