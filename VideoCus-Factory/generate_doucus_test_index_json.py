...
# s3_dir = 'yuanhao_cai/VideoEdit/label/double_cus_test_3/'
# s3_dir = 'yuanhao_cai/VideoEdit/label/double_cus_test_4/'
# s3_dir = 'yuanhao_cai/VideoEdit/label/double_cus_test_5/'
s3_dir = 'yuanhao_cai/VideoEdit/label/double_cus_test_6/'
...
local_json_path = save_dir + 'double_cus_test.json'
